...
public class Partner extends Model {
        ...
        static Field lang = fields.Selection(self -> _lang_get(self)).string("Language")
        ...
        static Field tz = fields.Selection(Partner::_tz_get).string("Timezone")
        ...
        // static Field bank_ids = fields.One2many("res.partner.bank", "partner_id",
        // "Banks");
        ...
        static Field type = fields.Selection(Arrays.asList(new Pair<>("contact", "Contact"),
                        new Pair<>("invoice", "Invoice Address"), new Pair<>("delivery", "Delivery Address"),
                        new Pair<>("other", "Other Address"), new Pair<>("private", "Private Address")))
        ...
        public void _compute_display_name(RecordSet self) {
                Kvalues diff = new Kvalues(k -> k.set("show_address", null).set("show_address_only", null)
                                .set("show_email", null).set("html_format", null).set("show_vat", null));
        ...
        static List<String> _lang_get(RecordSet self) {
                return (List<String>) self.env("res.lang").call("get_installed");
        }
