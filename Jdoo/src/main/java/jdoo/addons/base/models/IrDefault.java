...
public class IrDefault extends Model {
    ...
    public static Field field_id = fields.Many2one("ir.model.fields").string("Field").required(true).ondelete("cascade")
            .index(true);
    ...
    public static Field company_id = fields.Many2one("res.company").string("Company").ondelete("cascade").index(true)
